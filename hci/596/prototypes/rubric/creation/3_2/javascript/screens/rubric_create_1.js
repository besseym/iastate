jQuery("#simulation")
  ...
  .delegate(".s-233f3ecc-32d6-4749-bd4b-0b5de14e7eb3 .pageload", "pageload", function(event, data) {
    ...
    else if(jFirer.is("#s-input_sub_category_7")) {
      cases = [
        {
          "blocks": [
            {
    ...
    else if(jFirer.is("#s-input_sub_category_8")) {
      cases = [
        {
          "blocks": [
            {
    ...
    else if(jFirer.is("#s-input_sub_category_9")) {
      cases = [
        {
          "blocks": [
            {
    ...
    else if(jFirer.is("#s-input_sub_category_10")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimSetValue",
                  "parameter": {
                    "target": "#s-input_sub_category_10",
                    "value": {
                      "datatype": "variable",
                      "element": "sub_category2_2"
                    }
