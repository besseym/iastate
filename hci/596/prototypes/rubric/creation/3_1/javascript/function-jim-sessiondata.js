function initData() {
  ...
  jimData.variables["level2_desc"] = "Enter Level Description";
  jimData.variables["level3_value"] = "2.5";
  jimData.variables["level2_name"] = "Enter Level Name";
  jimData.variables["category2_percent"] = "50";
  ...
  jimData.variables["level3_desc"] = "Enter Level Description";
  jimData.variables["level_min_value"] = "0";
  jimData.variables["achieve_min_points"] = "0";
  jimData.variables["category1_percent"] = "50";
  jimData.variables["rubric_data"] = "";
  jimData.variables["sub_category1_2"] = "Enter Sub-Category Name";
  jimData.variables["sub_category1_1"] = "Enter Sub-Category Name";
  jimData.variables["sub_category2_2"] = "Enter Sub-Category Name";
  jimData.variables["category2_desc"] = "Enter Category Description";
  jimData.variables["achieve_level"] = "";
  jimData.variables["sub_category2_1"] = "Enter Sub-Category Name";
  jimData.variables["level1_desc"] = "Enter Level Description";
